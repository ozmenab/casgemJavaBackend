...
public class Messages {
    ...
    public static final String InstructorsListed = "Instructors Listed";
    public static final String ApplicantsListed = "Applicants Listed";
    ...
    public static final String ApplicantExists = "Applicant Exists";
    public static final String ApplicantIfNotExists = "Applicant no exists";
    public static final String EmployeeExists = "Employee Exists";
    public static final String EmployeeIfNotExists = "Employee no exists";
    public static final String BootcampIfNotExists = "Bootcamp no exists";
